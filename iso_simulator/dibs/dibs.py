...
class DIBS:
    ...
    def calculate_all_buildings_results(self, generate_data: GenerateData, weather_period: str):
        ...
        for index, building in enumerate(generate_data.all_buildings):
            print(building.scr_gebaeude_id)
            result_of_a_building = self.calculate_result_of_all_buildings(generate_data, weather_period, index)
    ...
    def calculate_result_of_one_building(self, generate_data: GenerateData, building_id: str, weather_period: str):

        buildings_to_simulate = generate_data.all_buildings
        building_to_simulate = generate_data.filter_building_by_src_id(building_id)
        gwp_pe_factors = generate_data.gwp_PE_Factors

        simulator = BuildingSimulator(self.datasource, buildings_to_simulate, building_to_simulate, gwp_pe_factors,
                                      weather_period, 'din18599', 'mid', 'sia2024')

        print(building_to_simulate.scr_gebaeude_id)
        t_set_heating_temp = building_to_simulate.t_set_heating
        ...
        for hour in range(8760):
            ...
            heat.append(simulator.building_object.t_set_heating)
    ...
    def calculate_result_of_all_buildings(self, generate_data: GenerateData, weather_period: str, index: int):
