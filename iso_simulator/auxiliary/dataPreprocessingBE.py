"""
Module serves for data generation from original BE-Data to a modified input dataset (building_data) used as input in annualSimulation.py
...
def generateBuildingData():
    ...
    be_data_original = pd.read_excel(r'../auxiliary/BE_data/BE_BuildingData.xlsx')
    # Import Data from DIN V 18599-10:2018-09, DIN V 18599-4:2018-09
    profile_zuweisung_18599_10 = pd.read_excel(r'../auxiliary/BE_data/normData.xlsx', sheet_name = 'profile_zuweisung_18599_10', decimal = ",")
    data_18599_10_4 = pd.read_excel(r'../auxiliary/BE_data/normData.xlsx', sheet_name = 'data_18599_10_4', decimal = ",")
