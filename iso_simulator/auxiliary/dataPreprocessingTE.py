"""
Module serves for data generation from original TE-Data to a modified input dataset (building_data) used as input in annualSimulation.py
...
def generateBuildingData():
    ...
    data_te = pd.read_excel(r'../auxiliary/TE_data/#Alle_Daten_DB_TE_inkl_TEK_GEO_Auszug.xlsx')
    ...
    max_occupancy_be_imputiert = pd.read_excel(r'../auxiliary/TE_data/DB_BE_q25_1_imputiert_Auszug.xlsx')
    ...
    profile_zuweisung = pd.read_csv(r'../auxiliary/TE_data/excel_export/profile_18599_10_zuweisung.csv', sep = ';', encoding= 'unicode_escape')
    profile_data = pd.read_csv(r'../auxiliary/TE_data/excel_export/profile_18599_10_data.csv', sep = ';', encoding= 'unicode_escape', decimal=",")
    ...
    heating_supply_system_more_than_one_adj = pd.read_excel(r'../auxiliary/TE_data/heating_supply_system_more_than_one_adj_Auszug.xlsx')
    ...
    return SimulationData_Tiefenerhebung
