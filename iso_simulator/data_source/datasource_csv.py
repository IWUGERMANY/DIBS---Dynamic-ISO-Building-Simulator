...
from iso_simulator.utils.utils_epwfile import (
    get_coordinates_plz,
...
from iso_simulator.utils.utils_hkgeb import (
    hk_and_uk_in_zuweisungen,
    hk_or_uk_not_in_zuweisungen,
    hk_in_zuweisungen,
    uk_in_zuweisungen,
)
from iso_simulator.utils.utils_tekreader import (
    get_tek_name,
...
class DataSourceCSV(DataSource):
    ...
    def get_user_buildings(self, path: str) -> List[Building]:
        ...
        return [Building(*row.values) for _, row in building_data.iterrows()]
    ...
    def choose_and_get_the_right_weather_data_from_path(
        ...
        return (
            ...
            if weather_period == "2007-2021"
                ...
                os.path.join(f"iso_simulator/auxiliary/weather_data/{file_name}")
            )
        )
    ...
    def get_epw_file(self, plz: str, weather_period: str) -> EPWFile:
        ...
        ) = get_coordinates_plz(plz_data, plz)
    ...
    def result_of_all_hours_to_csv(
        ...
        data_frame.to_csv(f"{folder_path}/{build_file_name}")
    ...
    def build_all_results_of_all_buildings(
        ...
        """
        list_of_results = [
            self.result_to_pandas_dataframe(result, user_arguments)
