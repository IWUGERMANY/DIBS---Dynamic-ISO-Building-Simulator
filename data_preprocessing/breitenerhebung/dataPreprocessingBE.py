...
# modified uk_geb cleanup that correctly interpretes strange occurences of DB_DIBS data.
# Somehow also it is fixed and defined as character in R and in the export here in Python, 
# some strange occurences of  disapearing last 0 vor example in '1.00' to '1.0'. 
...
cleanup_uk_geb = {"uk_geb": { '1.00': 'Bürogebäude', #! Sonstige uk_geb: Annahme Zuweisung anders Profils, da diese nicht in Norm existiert. Zuweisung als 1.06 in DB_BE nicht umgesetzt!!! Sondern als 1 was in Imputation zu 1.00 korrigiert wird.
                              ...
                              '3.1': 'Pflegeheim für Behinderte (ohne eigene Haushaltsführung der Bewohner/innen)',
                              ...
                              '8.1': 'zentrales Wirtschaftsgebäude (z.B. Zentralküche oder -wäscherei in Krankenhaus)', #!1
                              '8.11': 'Rechenzentrum',                                                                                         
                              ...
                              '11.05': 'Sonstige Gebäudefunktion'}}  # nicht in Norm definiert!
